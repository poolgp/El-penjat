...
function reiniciar() {
  ...
  const finalDescripcion = document.getElementById("descripcionFinal");
  finalDescripcion.style.visibility = "hidden";

  const palabraContainer = document.getElementById("palabra");
  palabraContainer.style.visibility = "visible";

  const abcContainer = document.getElementById("containerLletras");
  abcContainer.style.visibility = "visible";

  const contadorErrores = document.getElementById("contadorErrores");
  contadorErrores.style.visibility = "visible";

  const tornarJugar = document.getElementById("tornarJugar");
  tornarJugar.style.visibility = "hidden";
